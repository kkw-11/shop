...
public class ItemService {
    ...
    public Long updateItem(ItemFormDto itemFormDto, List<MultipartFile> itemImgFileList) throws Exception {
        ...
        log.info("ItemService updateItem 상품 수정 전 {}", item.toString());
        item.updateItem(itemFormDto);
        log.info("ItemService updateItem 상품 수정 후 {}", item.toString());
    ...
    public Page<ItemMngDto> getItemMngPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        return itemRepository.getItemMngPage(itemSearchDto, pageable);
    }
